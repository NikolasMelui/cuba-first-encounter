package com.company.cubafirstencounter;
...
public class CubafirstencounterTestContainer extends TestContainer {

    public CubafirstencounterTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/cubafirstencounter/app.properties",
    ...
    public static class Common extends CubafirstencounterTestContainer {

        public static final CubafirstencounterTestContainer.Common INSTANCE = new CubafirstencounterTestContainer.Common();
